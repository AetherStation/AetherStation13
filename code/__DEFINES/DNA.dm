...
GLOBAL_LIST_INIT(implant_class_tiers, list(CYBER_CLASS_DEFAULT = 0, CYBER_CLASS_CRACKED = 0, CYBER_CLASS_NT_LOW = 1, CYBER_CLASS_NT_HIGH = 2, CYBER_CLASS_SYNDICATE = 3, CYBER_CLASS_TERRA = 4))
