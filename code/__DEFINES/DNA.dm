...
#define CYBER_CLASS_NT_LOW "basic NT"
#define CYBER_CLASS_NT_HIGH "advanced NT"
#define CYBER_CLASS_SYNDICATE "syndicate"
#define CYBER_CLASS_TERRA "terragov"
#define CYBER_CLASS_CRACKED "cracked"
#define CYBER_CLASS_CRACKED_BAD "badly cracked"
#define CYBER_CLASS_ADMIN "admin"

GLOBAL_LIST_INIT(implant_class_tiers, list(CYBER_CLASS_DEFAULT = 0, CYBER_CLASS_CRACKED = 2, CYBER_CLASS_NT_LOW = 1, CYBER_CLASS_NT_HIGH = 2, CYBER_CLASS_SYNDICATE = 3, CYBER_CLASS_TERRA = 4, CYBER_CLASS_CRACKED_BAD = 3))
