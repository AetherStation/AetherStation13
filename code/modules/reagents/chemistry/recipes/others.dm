...
/datum/chemical_reaction/capsaicincondensation
	...
	required_reagents = list(/datum/reagent/consumable/capsaicin = 1, /datum/reagent/consumable/ethano
...
/datum/chemical_reaction/saltpetre
	...
	required_reagents = list(/datum/reagent/potassium = 1, /datum/reagent/nitrogen = 1, /datum/reagent/oxygen = 3)T
