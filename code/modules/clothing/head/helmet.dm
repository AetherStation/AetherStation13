...
/obj/item/clothing/head/helmet/marine
	...
	inhand_icon_state = "helmetalt"
	armor = list(MELEE = 35, BULLET = 60, LASER = 30, ENERGY = 30, BOMB = 40, BIO = 20, RAD = 0, FIRE = 40, ACID = 50)
	can_flashlight = TRUE
	dog_fashion = null
...
/obj/item/clothing/head/helmet/marine/security
	...
	armor = list(MELEE = 35, BULLET = 60, LASER = 30, ENERGY = 30, BOMB = 40, BIO = 20, RAD = 0, FIRE = 50, ACID = 50)
