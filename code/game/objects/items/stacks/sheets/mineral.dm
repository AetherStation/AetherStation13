...
GLOBAL_LIST_INIT(sandstone_recipes, list ( \
	...
	new/datum/stack_recipe("sandstone door", /obj/structure/mineral_door/sandstone, 10, time = 20, one_per_turf = TRUE, on_floor = TRUE), \
...
GLOBAL_LIST_INIT(diamond_recipes, list ( \
	new/datum/stack_recipe("diamond door", /obj/structure/mineral_door/transparent/diamond, 10, time = 20, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(uranium_recipes, list ( \
	new/datum/stack_recipe("uranium door", /obj/structure/mineral_door/uranium, 10, time = 20, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(plasma_recipes, list ( \
	new/datum/stack_recipe("plasma door", /obj/structure/mineral_door/transparent/plasma, 10, time = 20, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(gold_recipes, list ( \
	new/datum/stack_recipe("golden door", /obj/structure/mineral_door/gold, 10, time = 20, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(silver_recipes, list ( \
	new/datum/stack_recipe("silver door", /obj/structure/mineral_door/silver, 10, time = 20, one_per_turf = 1, on_floor = 1), \
